...
?>
<img class='actionIcon' height="96%" src="<?=$icon;?>?rev=<?=time();?>" name="<?=$link;?>" onclick="window.location.href = this.name;" title="<?=$value;?>">
<?php } ?>
<img class='actionIcon' height="96%" src="sys.exit.png?rev=<?=time();?>" onclick="window.location.href = '../../';" title="Exit">
</p>
</div>
</body>
</html>
